		...
		<div className='part-events'>
			<div className="container">
				<div className="row">
					...
					{ pastEvents.posts.length < pastEvents.foundPosts &&
						<div className="col-12 text-center">
							<a href={`${window.location.href}#`} className={`btn-main min-width ${isLoading ? 'btn-disabled' : ''}`} onClick={loadMoreEvents(data.ajaxUrl, pastEvents, setPastEvents, isLoading, setIsLoading)}>
								View more {'  '}
